...
- **마지막 수정 완료 항목 ID**: `[SCR-10 소셜, 친구 친선전 & 길드 완료] SCR-10-01(비동기 친선 대전 링크 복사 & 일일 길드 미션 3종 HUD 게이지 + 올클리어 보너스 +50 SNS), SCR-10-02(모바일 4대 서브 탭바 [정보/레이드/조각·승부/친구] 분리 & DESIGN.md 헤어라인 정돈), SCR-10-03(길드 특가 보급소 25 SNS AP 물약 충전 & 용병/조각 햅틱 피드백 & 100% 로컬스토리지 SSOT) 전수 구현 및 빌드/실측 검증 완료!`
- **최종 업데이트 일시**: 2026-09-17 04:00 (KST)
