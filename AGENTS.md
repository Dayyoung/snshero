...
## 스프레드시트 개선 작업 진행 상태
- **마지막 수정 완료 항목 ID**: `[Row 630 / CSV Row 642] 110종 전체 미션 게임 퓨어 제스처 컨트롤러, 3단계 표준 온보딩 튜토리얼 모달, 상단 70% 시야 개방 1줄 미니멀 HUD, 100% 확정 SNS 포인트 정산 팝업 및 복셀 78종 전수 심사·카드 스프라이트화 100% 전수 완공`
- **최종 업데이트 일시**: 2026-08-27 13:50 (KST)
