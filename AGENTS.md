...
## 스프레드시트 개선 작업 진행 상태
- **마지막 수정 완료 항목 ID**: `101` (전체 구글 시트 항목 #1 ~ #101 구현 및 검증 완료: Invalid drop target shading, 추천 덱 불러오기, flip vs defense SFX 구분, 인벤토리 용량 표시, 웹툰 자동 연결, 스킬 트리 애니메이션 커넥터, 로비 서랍 구조, 카드 상세 서브 탭, 전투 결과 접이식 보상 상세 등)
- **최종 업데이트 일시**: 2026-08-07 23:45
