...
const MyDeckView = lazy(() => import('./views/MyDeckView').then(module => ({ default: module.MyDeckView })));
...
const EventView = lazy(() => import('./views/EventView').then(module => ({ default: module.EventView })));
const SettingView = lazy(() => import('./views/SettingView').then(module => ({ default: module.SettingView })));
const PlayGameView = lazy(() => import('./views/PlayGameView').then(module => ({ default: module.PlayGameView })));
const RankingView = lazy(() => import('./views/RankingView').then(module => ({ default: module.RankingView })));
...
const CompanionView = lazy(() => import('./views/CompanionView').then(module => ({ default: module.CompanionView })));
const ProfileView = lazy(() => import('./views/ProfileView').then(module => ({ default: module.ProfileView })));
const SkillView = lazy(() => import('./views/SkillView').then(module => ({ default: module.SkillView })));
const StockMarketView = lazy(() => import('./views/StockMarketView').then(module => ({ default: module.StockMarketView })));
const CardMarketplaceView = lazy(() => import('./views/CardMarketplaceView').then(module => ({ default: module.CardMarketplaceView })));
const PredictionMarketView = lazy(() => import('./views/PredictionMarketView').then(module => ({ default: module.PredictionMarketView })));
const WikiHomeView = lazy(() => import('./views/WikiHomeView').then(module => ({ default: module.WikiHomeView })));
const WorldCodexView = lazy(() => import('./views/WorldCodexView').then(module => ({ default: module.WorldCodexView })));
const WikiHowToPlayView = lazy(() => import('./views/WikiHowToPlayView').then(module => ({ default: module.WikiHowToPlayView })));
const WikiTipView = lazy(() => import('./views/WikiTipView').then(module => ({ default: module.WikiTipView })));
const WikiCardView = lazy(() => import('./views/WikiCardView').then(module => ({ default: module.WikiCardView })));
const WikiItemView = lazy(() => import('./views/WikiItemView').then(module => ({ default: module.WikiItemView })));
const WikiSkillView = lazy(() => import('./views/WikiSkillView').then(module => ({ default: module.WikiSkillView })));
const GodView = lazy(() => import('./views/GodView').then(module => ({ default: module.GodView })));
const GuildListView = lazy(() => import('./views/GuildListView').then(module => ({ default: module.GuildListView })));
const GuildDetailView = lazy(() => import('./views/GuildDetailView').then(module => ({ default: module.GuildDetailView })));
const CommunityView = lazy(() => import('./views/CommunityView').then(module => ({ default: module.CommunityView })));
const PlaygroundView = lazy(() => import('./views/PlaygroundView').then(module => ({ default: module.PlaygroundView })));
const BoostView = lazy(() => import('./views/BoostView').then(module => ({ default: module.BoostView })));
const Web3LandingView = lazy(() => import('./views/Web3LandingView').then(module => ({ default: module.Web3LandingView })));
const SeasonHubView = lazy(() => import('./views/SeasonHubView').then(module => ({ default: module.SeasonHubView })));
const ReferralView = lazy(() => import('./views/ReferralView').then(module => ({ default: module.ReferralView })));
const CreatorLandingView = lazy(() => import('./views/CreatorLandingView').then(module => ({ default: module.CreatorLandingView })));
const DeckUpgradeModal = lazy(() => import('./components/DeckUpgradeModal').then(module => ({ default: module.DeckUpgradeModal })));
const SimulationOverlay = lazy(() => import('./components/SimulationOverlay').then(module => ({ default: module.SimulationOverlay })));
