...
export const VoxelTankBounceGame: React.FC<VoxelTankBounceGameProps> = ({
  ...
  return (
    <div className="relative w-full h-[100dvh] bg-slate-950 flex flex-col font-mono select-none overflow-hidden">
      ...
      {/* Mobile Controls */}
      <div className="absolute bottom-6 left-4 right-4 z-20 flex items-center justify-between pointer-events-auto">
        <div className="flex gap-2">
          <button
            onPointerDown={() => { stateRef.current.keys['a'] = true; }}
            onPointerUp={() => { stateRef.current.keys['a'] = false; }}
            className="w-16 h-16 bg-slate-900/90 active:bg-cyan-600 border border-slate-700 rounded-sm text-white font-black text-xl flex items-center justify-center shadow-lg"
          >
            ◀
          </button>
          <button
        ...
        <div className="flex gap-3">
          <button
            ...
            className="w-16 h-16 bg-slate-900/90 active:bg-cyan-600 border border-slate-700 rounded-sm text-white font-black text-xs flex items-center justify-center shadow-lg"
          >
            FORWARD
          </button>
          <button
            onClick={fireShell}
            className="w-20 h-16 bg-amber-500 active:bg-amber-400 border border-amber-300 rounded-sm text-slate-950 font-black text-sm flex flex-col items-center justify-center shadow-lg"
          >
            <Crosshair size={22} />
            FIRE
          </button>
