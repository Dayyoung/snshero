...
export const TreasureChestUnlockModal: React.FC<TreasureChestUnlockModalProps> = ({
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-[300] flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-xs font-mono">
        <motion.div
        ...
        >
          ...
          <div className="flex-1 min-h-0 overflow-y-auto pr-0.5 space-y-3">
            <p className="text-[10px] text-white/80 leading-relaxed text-center">
              {language === 'ko'
            ...
            {isOpened && selectedChest !== null && (
              <div className="bg-emerald-950/70 border border-emerald-400/80 p-2.5 rounded-none text-center">
