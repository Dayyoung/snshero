...
import { Sparkles, Check, Shield, Flame, Droplets, Mountain, Wind, Skull } from "lucide-react";
...
export const CardAcquisitionModal: React.FC<CardAcquisitionModalProps> = ({
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-[10005] flex items-center justify-center p-4 bg-black/85 backdrop-blur-md select-none">
        <motion.div
          initial={{ scale: 0.8, opacity: 0, y: 20 }}
          animate={{ scale: 1, opacity: 1, y: 0 }}
          exit={{ scale: 0.8, opacity: 0, y: 20 }}
          transition={{ type: "spring", damping: 20, stiffness: 260 }}
          className="relative w-full max-w-sm bg-gradient-to-b from-[#181326] via-[#100d1c] to-[#0a0814] border-2 border-amber-400 rounded-sm p-4 sm:p-5 text-white font-mono shadow-[0_0_40px_rgba(245,158,11,0.4)] overflow-hidden flex flex-col items-center gap-3.5 text-center"
        >
          {/* Subtle Radial Glow */}
          ...
          {/* Card Frame Showcase */}
          <div className="relative z-10 w-44 sm:w-48 bg-[#14121e] border-2 border-amber-400/90 rounded-sm overflow-hidden shadow-[0_0_24px_rgba(245,158,11,0.3)] flex flex-col">
            {/* Header bar */}
          ...
          <div className="relative z-10 text-[10px] text-emerald-400 bg-emerald-950/80 border border-emerald-500/50 px-2.5 py-1 rounded-xs flex items-center gap-1.5">
