    ...
    >
      ...
      {isVertical ? (
        ...
        >
          ...
          <div className="absolute inset-0 bg-slate-950/50 backdrop-blur-[1px] group-hover:bg-slate-950/30 transition-colors duration-300 flex items-center justify-center px-2 sm:px-4 py-1">
            <div className="text-center transform translate-y-0 group-hover:-translate-y-0.5 transition-transform duration-300 max-w-full overflow-hidden px-1">
              <span className="text-[8.5px] sm:text-[9.5px] md:text-xs text-yellow-400 font-black tracking-wider uppercase block mb-0.5 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] animate-pulse">
                ★ OFFICIAL MERCHANDISE SHOP ★
              </span>
              <span className="text-[9.5px] sm:text-xs md:text-sm text-white font-extrabold tracking-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)] truncate block">
                {t('shop_banner_text', language)}
              </span>
            </div>
          </div>
